...
public class ChooseSubServiceTypeActivity extends AppCompatActivity implements View.OnClickListener, SPSubServiceCheckedListener {
    ...
    public void onBackPressed() {
        ...
        if(fromactivity != null && fromactivity.equalsIgnoreCase("ServiceDetailsAdapter")){
            Intent intent = new Intent(getApplicationContext(), ServiceProviderRegisterFormActivity.class);
            ...
            finish();
        }else if(fromactivity != null && fromactivity.equalsIgnoreCase("ServiceProviderRegisterFormActivity")){
            Intent intent = new Intent(getApplicationContext(), ServiceProviderRegisterFormActivity.class);
            intent.putExtra("fromactivity",TAG);
            intent.putExtra("serviceProviderRegisterFormCreateRequestArrayList",serviceProviderRegisterFormCreateRequestArrayList);
            startActivity(intent);
            finish();
        }else if(fromactivity != null && fromactivity.equalsIgnoreCase("ServiceProviderEditFormActivity")){
            ...
            Intent intent = new Intent(getApplicationContext(), ChooseServiceTypeActivity.class);
            intent.putExtra("fromactivity",TAG);
            intent.putExtra("serviceProviderRegisterFormCreateRequestArrayList",serviceProviderRegisterFormCreateRequestArrayList);
            startActivity(intent);
            finish();
