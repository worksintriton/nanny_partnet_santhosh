package com.triton.nannypartners.fragmentserviceprovider.myappointments;
...
import com.triton.nannypartners.adapter.SPNewAppointmentAdapter;
...
import com.triton.nannypartners.requestpojo.SPAppointmentRequest;
               ...
               if (response.body() != null) {
                   ...
                   if(200 == response.body().getCode()){
                       if(response.body().getData() != null && response.body().getData().size()>0){
                           ...
                           txt_no_records.setText("No New Appointment");
