...
import com.triton.nannypartners.petlover.PetSubServiceActivity;
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        holder.img_petservice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, PetSubServiceActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
