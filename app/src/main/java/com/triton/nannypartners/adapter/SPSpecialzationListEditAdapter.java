...
public class SPSpecialzationListEditAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SPSpecialzationListEditAdapter(Context context, List<ServiceListResponse.DataBean.SpecializationBean> spSpecialzationList,List<ServiceProviderRegisterFormCreateRequest.BusSpecListBean> spSpecialzationListEdit, SPSpecialzationChckedListener spSpecialzationChckedListener) {
