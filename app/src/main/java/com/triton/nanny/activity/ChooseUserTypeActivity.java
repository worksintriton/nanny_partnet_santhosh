...
import com.triton.nanny.adapter.UserTypesListAdapter;
import com.triton.nanny.api.APIClient;
import com.triton.nanny.api.RestApiInterface;
import com.triton.nanny.interfaces.UserTypeSelectListener;
import com.triton.nanny.responsepojo.UserTypeListResponse;
...
public class ChooseUserTypeActivity extends AppCompatActivity implements UserTypeSelectListener, View.OnClickListener {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(ChooseUserTypeActivity.this,LoginActivity.class));
        finish();
    }
